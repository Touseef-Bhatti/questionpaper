...
if (!isset($baseUrl)) {
    ...
    // Find path to root by looking for '/admin/'
    $adminPos = strpos($path, '/admin/');
    if ($adminPos !== false) {
        $rootPath = substr($path, 0, $adminPos);
        $baseUrl = $protocol . $host . $rootPath;
    } else {
        // Fallback: if we are not in an admin folder, default to root
    ...
    <nav class="admin-navbar">
        <div class="admin-navbar-container">
            <div class="admin-nav-left">
                ...
                <a href="<?= $adminUrl ?>dashboard.php" class="admin-nav-brand">Ahmad Learning Hub</a>
            </div>
            ...
            <ul class="admin-nav-menu" id="adminNavMenu">
                ...
                <li class="nav-dropdown">
                    ...
                    <ul class="admin-dropdown-menu">
                        ...
                        <li><a href="<?= $adminUrl ?>manageAIcontent/test_mcq_generation.php">🧪 MCQ Diagnostics</a></li>
                ...
                <li class="admin-user-info">
                    ...
                    <a href="<?= $adminUrl ?>logout.php" class="nav-link-logout">🚪 Logout</a>
                </li>
            </ul>
        </div>
...
<style>
    /* admin-header.css - Professional admin navigation styling */
